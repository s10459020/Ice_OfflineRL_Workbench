...
TABLES = [
    ...
    ("noise_init_5e-4@hopper_d4rl_expert", "hopper_random", "hopper_d4rl_expert"),
    ("noise_init_5e-3@hopper_d4rl_expert", "hopper_random", "hopper_d4rl_expert"),
    ("noise_init_5e-2@hopper_d4rl_expert", "hopper_random", "hopper_d4rl_expert"),
    ("noise_init_5e-1@hopper_d4rl_expert", "hopper_random", "hopper_d4rl_expert"),
    ...
    ("noise_init_5e-4@hopper_replay_expert", "hopper_random", "hopper_replay_expert"),
    ("noise_init_5e-3@hopper_replay_expert", "hopper_random", "hopper_replay_expert"),
    ("noise_init_5e-2@hopper_replay_expert", "hopper_random", "hopper_replay_expert"),
    ("noise_init_5e-1@hopper_replay_expert", "hopper_random", "hopper_replay_expert"),
]

DATASETS = [
    "noise_init_5e-4@hopper_d4rl_medium",
    "noise_init_5e-3@hopper_d4rl_medium",
    "noise_init_5e-2@hopper_d4rl_medium",
    "noise_init_5e-1@hopper_d4rl_medium",
    "noise_init_5e-4@hopper_d4rl_expert",
    "noise_init_5e-3@hopper_d4rl_expert",
    "noise_init_5e-2@hopper_d4rl_expert",
    "noise_init_5e-1@hopper_d4rl_expert",
]
...
def save_tables(dataset_id_list: list[str], agent_id_list: list[str]) -> None:
    ...
    table_true(dataset_ids, agent_id_list, datas, lowers, uppers, table_path("experience_noise_init", "true_returns.csv"))
    table_mean(dataset_ids, agent_id_list, datas, lowers, uppers, table_path("experience_noise_init", "mean_returns.csv"))
    table_pr95(dataset_ids, agent_id_list, datas, lowers, uppers, table_path("experience_noise_init", "pr95_returns.csv"))
...
def save_boxplots(dataset_id_list: list[str], agent_id_list: list[str]) -> None:
    ...
    for index, (dataset_id, lower_id, upper_id) in enumerate(table_specs_list, start=1):
        ...
        output_path = VIEW_ROOT / "boxplot" / "experience_noise_init" / f"{index}. {dataset_id}.png"
