...
# Compare
# ====================
def build_our() -> tuple[ScasMeanAgent, ScasDynamicAgent]:
...
def init_compare() -> tuple[Any, ScasMeanAgent, torch.nn.Module, ScasDynamicAgent]:
    print_stage("Init")
...
def compare_act(ref: Any, our: ScasMeanAgent) -> None:
