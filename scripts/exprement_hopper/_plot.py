...
if __name__ == "__main__":
    ...
    plot("hopper_medium_replay_d4rl_aspl")
    plot("hopper_medium_replay_d4rl_bc")
    plot("hopper_medium_replay_d4rl_cql")
    plot("hopper_medium_replay_d4rl_iql")
    plot("hopper_medium_replay_d4rl_scas")
    plot("hopper_medium_expert_d4rl_aspl")
    plot("hopper_medium_expert_d4rl_bc")
    plot("hopper_medium_expert_d4rl_cql")
    plot("hopper_medium_expert_d4rl_iql")
    plot("hopper_medium_expert_d4rl_scas")
