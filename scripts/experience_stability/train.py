...
AGENTS = [
    # ([None, 0, 500_000], "td3"),
    # ([None, 0, 500_000], "td3_n"),
    # ([None, 0, 500_000], "td3_gp"),
    # ([None, 0, 500_000], "td3_gpn"),
    # ([None, 0, 500_000], "td3bc"),
    # ([None, 0, 500_000], "td3bc_n"),
    # ([None, 0, 500_000], "td3bc_gp"),
    # ([None, 0, 500_000], "td3bc_gpn"),
