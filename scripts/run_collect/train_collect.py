...
DATASET_ID = "train_agent_collect-v0"
...
def main() -> None:
    ...
    try:
        ...
        collector.create_dataset(
            ...
            code_permalink="https://example.com/train_agent_collect",
            eval_env=eval_env,
            description="Train Q-table from scratch and collect state/value dataset",
        )
