...
TABLES = [
    ...
    ("noise_init_1e-1@walker2d_d4rl_medium", "walker2d_random", "walker2d_d4rl_medium"),
    ("noise_init_5e-1@walker2d_d4rl_medium", "walker2d_random", "walker2d_d4rl_medium"),
    ("noise_init_1e0@walker2d_d4rl_medium", "walker2d_random", "walker2d_d4rl_medium"),
    ("noise_init_5e-2@walker2d_d4rl_hybrid", "walker2d_random", "walker2d_d4rl_medium"),
    ("noise_init_1e-1@walker2d_d4rl_hybrid", "walker2d_random", "walker2d_d4rl_medium"),
    ("noise_init_5e-1@walker2d_d4rl_hybrid", "walker2d_random", "walker2d_d4rl_medium"),
    ("noise_init_1e0@walker2d_d4rl_hybrid", "walker2d_random", "walker2d_d4rl_medium"),
    ("noise_init_5e-2@walker2d_replay_medium", "walker2d_random", "walker2d_d4rl_medium"),
    ("noise_init_1e-1@walker2d_replay_medium", "walker2d_random", "walker2d_d4rl_medium"),
    ("noise_init_5e-1@walker2d_replay_medium", "walker2d_random", "walker2d_d4rl_medium"),
    ("noise_init_1e0@walker2d_replay_medium", "walker2d_random", "walker2d_d4rl_medium"),
]
...
def save_tables(dataset_id_list: list[str], agent_id_list: list[str]) -> tuple[Path, ...]:
    ...
    data_values = [
        [_task_value(dataset_id, agent_id) for agent_id in agent_ids]
