...
RUNNER_ID = "bc_stochastic_invertedpendulum"
BATCH_SIZE = 64
TRAIN_STEPS = 300_000
EVAL_INTERVAL = 3_000
EVAL_BATCHES = 8
...
def eval_loss_pi(agent: ContinuousBCStochasticAgent, episode_batch: tuple[torch.Tensor, torch.Tensor, torch.Tensor, torch.Tensor, torch.Tensor]) -> dict[str, float]:
...
def main() -> None:
    ...
    agent = ContinuousBCStochasticAgent(obs_size=obs_dim, act_size=act_dim)
