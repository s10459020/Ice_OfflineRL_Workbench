...
DATASETS = [
    ("hopper_d4rl_medium@noise_state_5e-3", "hopper_random", "hopper_d4rl_medium"),
    ("hopper_d4rl_expert@noise_state_5e-3", "hopper_random", "hopper_d4rl_expert"),
    ("hopper_replay_medium@noise_state_5e-3", "hopper_random", "hopper_replay_medium"),
    ("hopper_replay_expert@noise_state_5e-3", "hopper_random", "hopper_replay_expert"),
]
...
def _task_id(dataset_id: str, agent_id: str, scale_noise: float) -> str:
    ...
    return f"{dataset_id}-noise_state_{noise_name}-{agent_id}-v0"
...
def build_tables() -> None:
    ...
    table_true(dataset_ids, AGENTS, datas, lowers, uppers, table_path("experience_noise_state", "true_returns.csv"))
    table_mean(dataset_ids, AGENTS, datas, lowers, uppers, table_path("experience_noise_state", "mean_returns.csv"))
    table_pr95(dataset_ids, AGENTS, datas, lowers, uppers, table_path("experience_noise_state", "pr95_returns.csv"))
