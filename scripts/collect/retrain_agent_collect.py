...
def main() -> None:
    ...
    try:
        ...
        collector.create_dataset(
            ...
            algorithm_name="q_learning_retrain",
            author="local_test",
            author_email="local_test@example.com",
            code_permalink="https://example.com/retrain_agent_collect",
            eval_env=eval_env,
            description="Load pretrained Q-table, continue training, and collect state/value dataset",
        )
        ...
        print(f"retrain_steps={total_steps} q_states={len(agent.Q)}")
