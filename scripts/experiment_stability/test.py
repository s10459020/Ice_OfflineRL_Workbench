...
TASKS = [
    ...
    # ("walker2d_d4rl_medium", "scc", 100_000, 500_000),
    # ("walker2d_d4rl_expert", "scc", 100_000, 500_000),
    # ("walker2d_d4rl_hybrid", "scc", 100_000, 500_000),
    # ("walker2d_replay_medium", "scc", 100_000, 500_000),
    # ("walker2d_replay_expert", "scc", 100_000, 500_000),
    # ("walker2d_d4rl_medium", "scc_n", 100_000, 500_000),
    # ("walker2d_d4rl_expert", "scc_n", 100_000, 500_000),
    # ("walker2d_d4rl_hybrid", "scc_n", 100_000, 500_000),
    # ("walker2d_replay_medium", "scc_n", 100_000, 500_000),
    # ("walker2d_replay_expert", "scc_n", 100_000, 500_000),
    # ("walker2d_d4rl_medium", "scc_gp", 100_000, 500_000),
    # ("walker2d_d4rl_expert", "scc_gp", 100_000, 500_000),
    # ("walker2d_d4rl_hybrid", "scc_gp", 100_000, 500_000),
    # ("walker2d_replay_medium", "scc_gp", 100_000, 500_000),
    # ("walker2d_replay_expert", "scc_gp", 100_000, 500_000),
]
