...
TASKS = [
    # ([None, 0, 100_000], "walker2d_d4rl_medium", "td3bc_plus", {}),
    # ([None, 0, 100_000], "walker2d_d4rl_hybrid", "td3bc_plus", {}),
    # ([None, 0, 100_000], "walker2d_d4rl_expert", "td3bc_plus", {}),
    # ([None, 0, 100_000], "walker2d_replay_medium", "td3bc_plus", {}),
    # ([None, 0, 100_000], "walker2d_replay_expert", "td3bc_plus", {}),
    ...
    # ([None, 0, 100_000], "walker2d_replay_expert", "td3bc_gp_plus", {}),
