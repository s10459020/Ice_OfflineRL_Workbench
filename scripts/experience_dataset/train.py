...
TASKS = [
    ...
    # ([None, 0, 500_000], "halfcheetah_d4rl_medium", "bc_deterministic", {}),
    # ([None, 0, 500_000], "halfcheetah_d4rl_hybrid", "bc_deterministic", {}),
    # ([None, 0, 500_000], "halfcheetah_d4rl_expert", "bc_deterministic", {}),
    # ([None, 0, 500_000], "halfcheetah_replay_medium", "bc_deterministic", {}),
    # ([None, 0, 500_000], "halfcheetah_replay_expert", "bc_deterministic", {}),
    # ([None, 0, 500_000], "halfcheetah_d4rl_medium", "bc_stochastic", {}),
    # ([None, 0, 500_000], "halfcheetah_d4rl_hybrid", "bc_stochastic", {}),
    # ([None, 0, 500_000], "halfcheetah_d4rl_expert", "bc_stochastic", {}),
    # ([None, 0, 500_000], "halfcheetah_replay_medium", "bc_stochastic", {}),
    # ([None, 0, 500_000], "halfcheetah_replay_expert", "bc_stochastic", {}),
