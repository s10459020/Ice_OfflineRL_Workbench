...
TASKS = [
    ...
    # ([None, 0, 500_000], "hopper_d4rl_medium", "aspl_r", {"weight_punish": 0.5}),
    # ([None, 0, 500_000], "hopper_d4rl_hybrid", "aspl", {"weight_punish": 0.5}),
    # ([None, 0, 500_000], "hopper_d4rl_hybrid", "aspl_r", {"weight_punish": 0.5}),
    # ([None, 0, 500_000], "hopper_d4rl_expert", "aspl", {"weight_punish": 1.0}),
    # ([None, 0, 500_000], "hopper_d4rl_expert", "aspl_r", {"weight_punish": 1.0}),
    # ([None, 0, 500_000], "hopper_replay_medium", "aspl", {"weight_punish": 0.5}),
    # ([None, 0, 500_000], "hopper_replay_medium", "aspl_r", {"weight_punish": 0.5}),
    # ([None, 0, 500_000], "hopper_replay_expert", "aspl", {"weight_punish": 1.0}),
    # ([None, 0, 500_000], "hopper_replay_expert", "aspl_r", {"weight_punish": 1.0}),
    ...
    # ([None, 0, 500_000], "halfcheetah_d4rl_medium", "aspl_r", {"weight_punish": 0.5}),
    # ([None, 0, 500_000], "halfcheetah_d4rl_hybrid", "aspl", {"weight_punish": 0.5}),
    # ([None, 0, 500_000], "halfcheetah_d4rl_hybrid", "aspl_r", {"weight_punish": 0.5}),
    # ([None, 0, 500_000], "halfcheetah_d4rl_expert", "aspl", {"weight_punish": 1.0}),
    # ([None, 0, 500_000], "halfcheetah_d4rl_expert", "aspl_r", {"weight_punish": 1.0}),
    # ([None, 0, 500_000], "halfcheetah_replay_medium", "aspl", {"weight_punish": 0.5}),
    # ([None, 0, 500_000], "halfcheetah_replay_medium", "aspl_r", {"weight_punish": 0.5}),
    # ([None, 0, 500_000], "halfcheetah_replay_expert", "aspl", {"weight_punish": 1.0}),
    # ([None, 0, 500_000], "halfcheetah_replay_expert", "aspl_r", {"weight_punish": 1.0}),
