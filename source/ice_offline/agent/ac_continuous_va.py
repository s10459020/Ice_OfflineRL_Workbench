...
class ActorCriticAgent:
    ...
    def update(self, o: np.ndarray, a: np.ndarray, r: float, o_: np.ndarray, done: bool) -> None:
        ...
        weight = self._A(obs_vector, act_vector, float(r), next_obs_vector, bool(done))
    ...
    def _A(self, obs_vector: np.ndarray, act_vector: np.ndarray, reward: float, next_obs_vector: np.ndarray, done: bool) -> np.float32:
        # A(s, a) = Q(s, a) - V(s)
