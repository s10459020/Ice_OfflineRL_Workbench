...
@dataclass
class HalfCheetahMediumDataset(Dataset):
    id: str = "halfcheetah_medium"
    env_id: str = "HalfCheetah-v5"
    minari_dataset_id: str = "mujoco/halfcheetah/medium-v0"
    dataset_path: str | Path = minari_root() / Path("mujoco/halfcheetah/medium-v0/data/main_data.hdf5")
