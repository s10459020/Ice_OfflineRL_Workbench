...
@dataclass
class Walker2dExpertDataset(Dataset):
    id: str = "walker2d_expert"
    env_id: str = "Walker2d-v5"
    minari_dataset_id: str = "mujoco/walker2d/expert-v0"
    dataset_path: str | Path = minari_root() / Path("mujoco/walker2d/expert-v0/data/main_data.hdf5")
