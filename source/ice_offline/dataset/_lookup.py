...
DATASET_TABLE: dict[str, Callable[[str], Dataset]] = {
    ...
    "hopper_one_simple": _custom_dataset("Hopper-v5", "hopper_one_simple"),
    "hopper_one_medium": _custom_dataset("Hopper-v5", "hopper_one_medium"),
    "hopper_one_expert": _custom_dataset("Hopper-v5", "hopper_one_expert"),
