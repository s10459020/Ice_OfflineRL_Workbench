...
@dataclass
class HalfCheetahMediumExpertDataset(Dataset):
    id: str = "halfcheetah_medium_expert"
    env_id: str = "HalfCheetah-v5"
    dataset_path: str | Path = Path("tmps/datasets/d4rl/halfcheetah_medium_expert-v2.hdf5")
