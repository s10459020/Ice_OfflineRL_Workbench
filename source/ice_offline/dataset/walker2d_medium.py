...
@dataclass
class Walker2dMediumDataset(Dataset):
    id: str = "walker2d_medium"
    env_id: str = "Walker2d-v5"
    minari_dataset_id: str = "mujoco/walker2d/medium-v0"
    dataset_path: str | Path = minari_root() / Path("mujoco/walker2d/medium-v0/data/main_data.hdf5")
