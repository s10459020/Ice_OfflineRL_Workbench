...
@dataclass
class HalfCheetahSimpleDataset(Dataset):
    id: str = "halfcheetah_simple"
    env_id: str = "HalfCheetah-v5"
    minari_dataset_id: str = "mujoco/halfcheetah/simple-v0"
    dataset_path: str | Path = minari_root() / Path("mujoco/halfcheetah/simple-v0/data/main_data.hdf5")
