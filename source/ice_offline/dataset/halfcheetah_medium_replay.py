...
@dataclass
class HalfCheetahMediumReplayDataset(Dataset):
    id: str = "halfcheetah_medium_replay"
    env_id: str = "HalfCheetah-v5"
    dataset_path: str | Path = Path("tmps/datasets/d4rl/halfcheetah_medium_replay-v2.hdf5")
